...
def generate_market_content(user_text: str) -> str:
    ...
    prompt = (
        ...
        "你是一位財富管理顧問的得力助手，常常主持財經節目，擅長把財經新聞轉化為讓客戶容易理解、有行動力的LINE推播文案。\n\n"
        "【用戶提供的市場新聞】\n"
        f"{news_content}\n\n"
        "【用戶指定的推薦標的】\n"
        f"{targets_list}\n\n"
        ...
        "【保守型投資人建議規則】\n"
        "請根據當日市場主題，給保守型投資人一句具體可行的建議。\n"
        "可以是：加碼短天期債、持有美元現金、配置高評級債券基金、等待回檔再布局、增加固定收益比重等。\n"
        "不要每次都固定寫黃金，要根據當日情境靈活建議。\n\n"
        ...
        "[方向說明，含DCI介紹]\n"
        "[若有對應標的，列出：▶ 標的名稱]\n\n"
        "🛡️ 保守型投資人這樣做：[根據當日情境，建議保守型投資人適合的配置或動作，一句具體建議]\n\n"
        "[今日投資金句 + emoji]"
    )
